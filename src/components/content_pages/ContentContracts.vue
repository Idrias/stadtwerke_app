      ...
      <div class="shadow" id="content">
        <table v-if="getContracts().length > 0">
          ...
          <tr v-for="contract in getContracts()" v-bind:key="contract">
            ...
            <td v-if="selectedCategory.id != 3">{{contract.costvar}} €/{{selectedCategory.unit}}</td>
            <td v-if="selectedCategory.id == 3">{{contract.costvardirty}} €/m³</td>
            <td v-if="selectedCategory.id == 3">{{contract.costvarrain}} €/m²</td>
          </tr>
        </table>
...
let contracts = [
  {company: "Stadtwerke AG", cid: "1245123", costfix:12, costvar:12.3, category: 0, start: "01.01.2000", end: "31.12.9999"},
  {company: "Stadtwerke SE", cid: "1245124", costfix:12, costvar:12.3, category: 0, start: "2000", end: "9999"},
  {company: "Stadtwerke GmbH", cid: "1245125", costfix:12, costvar:12.3, category: 1, start: "2000", end: "9999"},
  {company: "Stadtwerke GmbH", cid: "1245125", costfix:12, costvar:12.3, category: 3, start: "2000", end: "9999"},
  {company: "Stadtwerke GmbH", cid: "1245125", costfix:12, costvardirty:12.3, costvarrain: 1.23, category: 3, start: "2000", end: "9999"}
]
...
tr:not(:first-child):hover {background-color: var(--c3);}
